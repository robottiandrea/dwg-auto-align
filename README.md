...
Pulsanti:
- **Analizza** (solo stima/matching, nessun file scritto)
- **Allinea e salva** (esegue anche export DWG/report)

Nota GUI: le operazioni lunghe girano in background, quindi la finestra resta responsiva durante analisi/allineamento.
